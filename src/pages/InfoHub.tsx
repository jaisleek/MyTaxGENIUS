        ...
        <div className="bg-emerald-50/50 dark:bg-emerald-900/20 p-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-5 shadow-sm transition-colors duration-300 hover:border-emerald-300 dark:hover:border-emerald-700">
               ...
               <p className="text-sm text-slate-500 dark:text-slate-400">Calculated payments are safely routed directly into NRS corporate accounts. NaijaTax AI never holds your tax funds.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-5 shadow-sm transition-colors duration-300 hover:border-emerald-300 dark:hover:border-emerald-700">
          ...
          <div className="p-6 space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Under the Finance Act, small companies with an annual gross turnover of less than ₦25 million are exempted from paying CIT. Medium companies (₦25m - ₦100m) pay a reduced rate of 20%.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="font-semibold text-gray-900 dark:text-white">2. Value Added Tax (VAT)</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                SMEs with an annual turnover of less than ₦25 million are exempt from VAT registration and filing obligations.
              </p>
            </div>
            <div className="space-y-2">
