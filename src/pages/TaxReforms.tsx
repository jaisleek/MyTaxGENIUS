...
const faqs = [
  ...
  },
  {
    ...
    a: 'If your business turnover is less than ₦25 Million annually, you are 100% exempt from Company Income Tax (CIT) and VAT charging requirements. You only need to file an annual nil return.'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-xl border border-slate-100 dark:border-slate-800 transition-transform hover:-translate-y-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
              If your business makes less than ₦25M yearly, you pay 0% CIT. Withholding tax on small transactions has also been slashed to boost cash flow.
            </p>
            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">If your turnover is &lt; ₦25M, you are exempt from CIT. But you MUST still file a nil return on time to avoid harsh penalties.</p>
                </div>
              </div>
              <div className="flex items-start">
                <CheckCircle2 className="w-6 h-6 text-blue-500 mr-4 flex-shrink-0" />
